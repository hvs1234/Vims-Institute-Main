...
const ProgramCourseMain = () => {
  ...
  return (
    <>
      <div
        className="grid grid-cols-4 px-[4rem] py-[6rem] gap-[2rem] w-[100%] justify-center items-center text-center 
          transition-all duration-[0.4s] ease-linear relative h-[100%] max-xl:grid-cols-2 max-[500px]:grid-cols-1 bg-[#f2f2f2]"
      >
        <div
