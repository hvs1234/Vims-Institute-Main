...
const Hero = () => {
  ...
  return (
    <>
      <Header />
      <div
        className={`section-main py-[10rem] px-[40rem] w-[100%] relative object-cover h-[100%] transition-all duration-[0.4s] ease-linear  
      ...
      >
        ...
        <div className="relative w-[100%] flex flex-col gap-[1rem] justify-center items-start max-w-[100%] max-[400px]:max-w-[90%]">
          <p className="text-[3rem] text-[white] font-normal max-md:text-[2.2rem] uppercase">
            Verma Institute Of Management Studies
          </p>
          <h1 className="text-[5rem] text-[white] font-medium max-xl:text-[4rem] max-md:text-[3rem] max-w-[80%] max-sm:max-w-[100%]">
