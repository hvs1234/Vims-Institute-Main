    ...
    <>
      {bannerdata.map((e) => {
        return (
          <div
            key={e.id}
            className={`section-main py-[15rem] px-[20rem] w-[100%] h-[100%] bg-fixed relative object-cover ${e.img} bg-no-repeat bg-center bg-cover max-xl:px-[5rem] max-md:px-[3rem] max-md:h-[100%]`}
          >
